...
// Filter out all instances of 'literally'
storyWords = storyWords.filter(word => { return word !== unnecessaryWord});

// Check and replace misspelled words
...
// Find where the bad word is and replace it
...
// Find where the long word(s) is/are and replace it/them
